...
# TODO: Example of the correspondence. Terma-Proofs
...
# TODO: Example of the correspondence. Simplification-Execution
...
With these types, and by virtue of the Curry-Howard correspondence, Mikrokosmos
can be used as a proof checker on first-order intuitionistic logic.
...
Note that this is, in fact, an intuitionistic proof. Althoug
