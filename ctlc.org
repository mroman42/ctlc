...
#+latex_header_extra: \usepackage{FiraMono}
#+latex_header_extra: \usepackage[T1]{fontenc}

*** Colors                                                         :ignore:
#+latex_header: \definecolor{ugrColor}{HTML}{c6474b} % Usado en el título
#+latex_header: \definecolor{ugrColor2}{HTML}{c6474b} % Usado en secciones
...
# TODO: Terminal and pullbacks imply all finite limis
...
#+end_theorem
** TODO Initial algebras and inductive types
** Locally cartesian closed categories and dependent types
*** Quantifiers and subsets
**** Logical formulas as subsets                                  :ignore:
**** Substitution                                                 :ignore:
Substitution inside a formula

\[\begin{tikzcd}
\left\{a{:}A \mid P(f(a)) \right\} \rar{} \dar[swap,hook]{} &
\left\{ b{:}B \mid P(b) \right\} \dar[hook]{} \\
A \rar{f} & B \\
\end{tikzcd}\]

**** Weakening                                                    :ignore:
A particular case is weakening

\[\begin{tikzcd}
\left\{(a,b) : A \times B \mid P(a) \right\} \rar{} \dar[swap,hook]{} &
\left\{ a{:}A \mid P(a) \right\} \dar[hook]{} \\
A \times B \rar{\pi} & A \\
\end{tikzcd}\]

**** The pullback functor                                         :ignore:
**** Set example                                                  :ignore:
**** Quantifiers as adjoints                                      :ignore:
...
**** Types on a locally cartesian closed structure                :ignore:
...
\intr{\Gamma,b : B(a)} \dar\rar &
\intr{\Gamma,a:A,b:B} \dar{\pi_B} \ar[bend left=70]{dd}{\pi_{\Sigma}} \\
& \intr{\Gamma} \rar{a}\drar[equal] & \intr{\Gamma, a : A} \dar{\pi_A} \\
&& \intr{\Gamma}
\end{tikzcd}\]

The adjunction in the slice category,

# adj

can be rewritten as the introduction rule

**** Dependent product                                            :ignore:
...
with the equalities $(\lambda a.b)\ a' \equiv b[a'/a]$ and $(\lambda a.f\ a) \equiv f$ given
by naturality.
