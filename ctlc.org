...
characteristics that make untyped lambda calculus a proper programming
...
De Bruijn indexes to represent variable scope and bindings
...
the software as a library and as an executable on the appropriate
