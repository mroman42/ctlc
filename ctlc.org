...
*** TODO [#A] Añadir lista de referencias principales
  ...
  - nLab
*** TODO [#B] Teorema de Hedberg y cómo recuperar conjuntos con ETCS
*** TODO [#C] Añadir paradoja de Escardó para motivar topología y computación
*** TODO [#B] Añadir ejemplo topológico de nudo que no se cierra
...
*** TODO Agda exportado a HTML. Enlazar código o apéndices
...
for every arrow $f \colon C \to C'$, the following diagram commutes.
\[\begin{tikzcd}
...
#+END_proposition
#+BEGIN_proof
Crucially applying naturality of $\alpha'$, we have
\[\begin{aligned}
...
*** TODO Elementary Theory of the Category of Sets
...
*** TODO Translation between categories and types
*** TODO Avoiding the law of excluded middle
*** TODO Diaconescu's theorem
*** Dedekind reals
