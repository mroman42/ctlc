...
subject of much debate during the beginning of 20th century cite:martinlof08. 
...
cite:nordstrom90) helps to synthesize all these ideas in a formal system which
is an active subject of research (cite:kraus2016notions, cite:rabe2011kripke
...
(see cite:hottbook), a recent development relating type theory with topological constructions. 
...
**** TODO Note on the circle                                                           :noexport:
...
Categories are a surprisingly powerful and natural language to talk
