...
*** Yoneda Lemma
**** Motivation of Yoneda Lemma                                                          :ignore:
*Yoneda lemma* is one of the first results of pure category theory.
It allows us to embed any small category into a functor category over
the category of sets. It will be useful when studying presheaves and
algebraic theories (see Section [[sec-lawveretheories]]).
