...
will continue to work. The previous proofs can be extended to cover
all the new cases.
...
of typing rules.
 ...
 9) The $(\ast)$ rule simply creates the only element of $1$. It is a constructor
    of the unit type.
 ...
 10) The $(abort)$ rule extracts a term of any type from the void type.
...
given propositions, $\top,\bot$ representing thruth and falsity. The
