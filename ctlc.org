...
* Mikrokosmos
** TODO Programming environment                                   :noexport:
*** TODO The Haskell programming language
...
It is
  ...
  * based on the *System F\omega* with some restrictions. Crucially,
    it implements *System F* adding quantification over type operators
    even if it does not allow abstraction on type operators. The GHC
    Haskell compiler, however, adds extensions with dependent types.
    # https://stackoverflow.com/a/21220357/2552681

# Motivation, comitee
In the 1980s, many lazy programming languages were independently being
written by researchers such as Miranda, Lazy ML, Orwell, Clean or
Daisy. All of them were similar in expressive power, but their differences
were holding back the efforts to communicate ideas on functional programming.
A comitee was created in 1987 with the mission of designing a common lazy
functional language.

The complete history of Haskell is detailed on cite:hudak07_haskell.
...
*** TODO Testing and Continuous integration
