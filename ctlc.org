...
#+LATEX_HEADER_EXTRA: \usepackage{agda}
#+LATEX_HEADER_EXTRA: \usepackage{catchfilebetweentags} % \input{titlepage}
...
* Lambda calculus
** Untyped lambda calculus                                        :noexport:
...
*** Difference between proof by contradiction or proof of a negation
