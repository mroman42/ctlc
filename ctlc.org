 ...
 * *Agda*, a programming language which implements a variant of
 ...
 * *Cubical* cite:cohen16 and *RedPRL* cite:redprl provide experimental implementations
   of Cubical Type Theory, a different variant of type theory.

In this text, we will use Agda to write mathematics, taking ideas
from cite:Conor17. We will check proofs in Martin-Löf type theory
using its type system.
...
*** Homotopy type theory II: synthetic topology
