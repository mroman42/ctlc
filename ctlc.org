...
#+BEGIN_definition
The category $\Cat$ is defined as the category of (small) categories as
...
and morphisms of the $\Cat$ category of all categories.
...
If we consider the category of small categories $\Cat$, there is
a hom-profunctor $-^{-} \colon \Cat^{op} \times \Cat \to \Cat$ sending any two categories
 ...
 * $\eta\colon I \tonat T$, called /unit/; and
