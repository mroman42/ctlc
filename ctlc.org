...
developed (\S [[sec-verified]]). The first one implements positive real numbers as Dedekind
...
(see cite:troelstra2014). However, constructivism did never attracted the
